...
- (void)viewDidLoad {
    ...
    [_button setTitle:NSLocalizedStringWithDefaultValue(@"ui.statusbar.setup.knobs.itermstatusbarknobactionviewcontroller.configure_action.0dfccc6f", nil, NSBundle.mainBundle, @"Configure Action…", @"User-facing text in iTermStatusBarKnobActionViewController (viewDidLoad).")];
